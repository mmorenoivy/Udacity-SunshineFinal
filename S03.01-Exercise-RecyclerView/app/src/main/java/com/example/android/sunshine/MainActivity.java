...
public class MainActivity extends AppCompatActivity {
    ...
    // TODO (22) Extend RecyclerView.Adapter<ForecastAdapter.ForecastAdapterViewHolder> donne
  ...
  //  private TextView mWeatherTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  mWeatherTextView = (TextView) findViewById(R.id.tv_weather_data);
        ...
        mRecyclerVew = (RecyclerView) findViewById(R.id.recyclerview);
        ...
        mRecyclerVew.setLayoutManager(linearLayoutManager);
        ...
        mRecyclerVew.setAdapter(mForecastAdapter);
    ...
    private void showWeatherDataView() {
        ...
        mRecyclerVew.setVisibility(View.VISIBLE);
    ...
    private void showErrorMessage() {
        ...
        mRecyclerVew.setVisibility(View.INVISIBLE);
